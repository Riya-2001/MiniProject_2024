...
$sql ="SELECT ID FROM tblstaff WHERE ID=:eid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblstaff set Password=:newpassword where ID=:eid";
...
<head>
  ...
  <title>DentCare - Change Password</title>
