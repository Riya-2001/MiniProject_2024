...
<!--<script type="text/javascript">
  ...
  function checkAll() {
    ...
    if(addrUser()&&emailUser()&&distUser()&&distPin()&&phoneUser())
       {
         return true;
       }
       else
...
<div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <div class="form-group">
                                          <div class="form-group">
                  <input type="text" name="name" class="form-control input-sm" placeholder="Name" id="name" onkeyup="distPin()">
                  ...
                  <span style="color: red;font-size: 14px" id="f7"></span>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <div class="form-group">
                  <div class="form-group">
                  <input type="text" name="lno" class="form-control input-sm" placeholder="License Number" id="lno" onkeyup="distPin()">
                  <span style="color: red;font-size: 14px" id="f8"></span>
...
<div class="row">
                  ...
                  <span style="color: red;font-size: 14px" id="f7"></span>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                  <div class="form-group">
                  <div class="form-group">
                  <select class="form-control bfh-states" data-country="US" data-state="CA" name="specs" id="specs" onclick="distUser()">
                    <option value="null">Specialization</option>
                                    ...
                                    <option value="Oral Pathologist">Oral Pathologist</option>
              			    			 ...
              			    			 <br>
  			    			<input type="submit" value="Register" class="btn btn-info btn-block" > <?php //onclick="return checkAll()" ?>
              			    		</form>
