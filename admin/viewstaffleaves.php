<?php
  ...
  $sql="update tb_leaves set status=3 where status=0 and utype='staff'";
  $result = mysqli_query($conn,$sql);
  
  $sql = "select * from tb_staff inner join tb_leaves on tb_leaves.uid=tb_staff.loginid order by tb_leaves.id desc";
  $result = mysqli_query($conn,$sql);
?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Submit</button>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['totdays']." Day(s)"; ?></td>
                                            ...
                                            { ?>
                                               ...
                                               <a href="approveleave.php?t=<?php echo $row['id']; ?>"><button class="btn btn-success" ><i class="fa fa-check" aria-hidden="true"></i></button></a>
